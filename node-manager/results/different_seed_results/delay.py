...
for i, random_seed in enumerate(random_seeds):
    title = f'66 satellites, 5% failure, n={lofi_n}, packet delay over different seeds'
    ...
    drop_rate = lofi_n_data['delay']

    # 绘制散点图
    plt.scatter(id, drop_rate, color=f'C{i}', label=f'seed={random_seed}')
    plt.title(title)
    plt.ylabel('delay')
    plt.ylim(90, 120)
